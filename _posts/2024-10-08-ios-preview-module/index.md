...
타다 프로젝트에서는 이러한 Preview 기능이 원활하게 동작하지 않는 문제가 있었습니다. 프로젝트의 규모가 크다 보니 단순 Preview 로딩에도 상당한 시간이 소요되었습니다. 또한, Third-Party 라이브러리와 매크로 사용으로 인해, 의도치 않게 Preview가 충돌하거나 무한 로딩 상태에 빠지는 등의 문제가 발생해 정상적인 활용이 어려웠습니다.
